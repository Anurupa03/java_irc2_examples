...
//    private static final String name = "BasicToken";
//    private static final String symbol = "BST";
...
//        tokenScore = sm.deploy(owner,IRC2BasicToken2.class,name,symbol,decimals,initialSupply);
